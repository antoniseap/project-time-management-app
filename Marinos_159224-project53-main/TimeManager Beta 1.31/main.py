...
######### Main Menu #########
    ...
    def graphFunction(self, totaltime, lei, com):
        ...
        matplotlib.rcParams['figure.figsize'] = [22.0, 10.0]
        ...
        if len(lei) != 0:
            ...
            ax[0].set_title("Δραστηριότητες Ελεύθερου Χρόνου", wrap=True,
                            fontsize=10)  # Tίτλος για το subplot Ελεύθερου Χρόνου
        ...
        if len(com) != 0:
            ...
            if len(lei) != 0:
                ...
                ax[1].set_title("Δραστηριότητες Υποχρεώσεων", wrap=True,
                                fontsize=10)  # # Tίτλος για το subplot Υποχρεώσεων
                plt.setp(autotexts, size=8, weight="bold")
                plt.setp(texts, size=8)
            else:
    ...
    def possibleActivitiesMenu(self):
        ...
        self.leiGraph = []
        self.comGraph = []
        # Προσωρινές μεταβλητές για τις δραστηριότητες υποχρεώσεων και ελεύθερου χρόνου
